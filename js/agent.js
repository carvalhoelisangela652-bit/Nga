/* ═══════════════════════════════════════════════════════════════════
   TITAN v5 — agent.js
   Agentic loop CORRIGIDO — tool_result sempre enviado,
   sanitização de histórico, markdown rendering,
   sem bug de "tool_use ids found without tool_result blocks"
   Correção completa do erro de mensagens encadeadas
═══════════════════════════════════════════════════════════════════ */
...
function buildSystemPrompt(){
  ...
  return `Você é o TITAN Super Agent v5 — agente autônomo de DevOps de alta performance.
...
function clearAgentHistory(){
  ...
  appendAgentMsg("assistant","# ⚡ TITAN Super Agent v5\n\nHistórico limpo. Como posso ajudar?");
  addLog("info","AGENT","Histórico limpo");
}
